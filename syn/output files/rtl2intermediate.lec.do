...
# Generated on: Thu Jul 09 10:38:43 IST 2026 (Thu Jul 09 05:08:43 UTC 2026)
...
set logfile logs_Jul09-10:38:37/rtl2intermediate.lec.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/uart_top_pad -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  baud_gen.v uart_tx.v uart_rx.v uart_top.v uart_top_pad.v
elaborate_design -golden -root {uart_top_pad} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/uart_top_pad/fv_map.v.gz
...
#add_name_alias fv/uart_top_pad/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.uart_top_pad.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.uart_top_pad.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.uart_top_pad.rtl.fv_map.rpt
